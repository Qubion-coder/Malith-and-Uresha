              ...
              <div className="w-full h-full bg-white flex flex-col items-center justify-center">
                <div className="text-center space-y-2 mt-16">
                  <p className="text-sm tracking-[0.3em] uppercase font-light" style={{ color: 'var(--primary)' }}>
                    {guestName ? `Dear ${guestPrefix} ${guestName},` : 'You are invited to'}
                  </p>
                  <p className="text-xl sm:text-2xl font-serif" style={{ color: 'var(--primary)' }}>
                    {guestName ? 'We Cordially Invite You' : 'Celebrate Love'}
                  </p>
                </div>
              </div>
            </div>
