  ...
  const detailGroups = [
    {
      ...
      timeLabel: 'Time',
      timeValue: '7:00 PM',
      timeSub: 'Wedding celebration',
      venueLabel: 'Venue',
      venueValue: 'Mount Lavinia Hotel',
      venueSub: 'At The Empire Ballroom',
    }
  ];
            ...
            >
              ...
              <div className="relative z-10 flex h-full flex-col items-center justify-center px-8 text-center text-[#f5e6c8]">
                ...
                <h3 className="mt-5 font-serif text-4xl text-[#fff7de] drop-shadow-[0_4px_16px_rgba(0,0,0,0.75)]">
                  MALITH <span className="text-[#f0d18b]">&amp;</span> URESHA
                </h3>
                ...
                <p className="mt-5 text-xs uppercase tracking-[0.28em] text-[#C9A227]">October 25, 2026</p>
              </div>
